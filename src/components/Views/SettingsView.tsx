import { AlertCircle, Battery, CheckCircle2, Database, ExternalLink, EyeOff, FileText, Heart, Info, KeyRound, Link2, Palette, Radio, RefreshCw, Settings2, ShieldAlert, Sparkles } from 'lucide-react'
...
export function SettingsView() {
  ...
  const windowEffectDiagnostic = useStore(state => state.windowEffectDiagnostic)
