...
const officialIds = ['official.zailon.frosty', 'official.zailon.frosty-editor', 'official.zailon.visual-profiles', 'official.zailon.discord', 'official.zailon.provider.gamebanana', 'official.zailon.provider.nexus', 'official.zailon.provider.curseforge']
