...
export function ToolsView() {
  ...
  return <div className="h-full overflow-y-auto p-5 sm:p-7">
    <header><p className="font-mono text-[11px] uppercase tracking-[0.24em] text-gold/58">Maintenance</p><h1 className="mt-1 font-display text-2xl font-bold text-white">Outils</h1><p className="mt-1 max-w-2xl text-[11px] text-white/38">Actions locales, explicites et réversibles pour entretenir la bibliothèque.</p></header>
